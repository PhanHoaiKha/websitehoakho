...
<body class="login-page">
    <div class="login-header box-shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="login-menu">
                <ul>
                    <li><a href="login_client" style="color: var(--radius-color)">Đăng Nhập</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="login-wrap d-flex align-items-center flex-wrap justify-content-center" style="background-image: url('public/upload/background.jpeg'); background-size: 100% auto; background-position: center; background-repeat: no-repeat;">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center" style="color: var(--radius-color)">Đăng Ký</h2>
                        </div>
                        @if ($errors->any())
                        ...
                        <form action="{{ URL::to('mail_register_client') }}" method="post" style="text-align: center">
                            ...
                            <div class="input-group custom">
                                <input type="text" name="username" class="form-control form-control-lg format_name_input" placeholder="Tên người dùng">
          ...
          background-color: var(--radius-color); color:white;" value="Đăng Ký" />
                                    </div>
                                    <div class="row">
