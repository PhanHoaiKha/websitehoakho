                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center" style="color: var(--radius-color)">Lấy lại mật khẩu</h2>
                        </div>
                        @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-0 btn-login">
                                        <input type="submit" class="btn btn-lg btn-block" style="background-color: var(--radius-color); color:white;" value="Gửi" />
                                    </div>
                                </div>
                            </div>
                        </form>
