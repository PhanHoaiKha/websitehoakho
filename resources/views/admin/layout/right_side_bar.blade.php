<div class="right-sidebar">
    ...
    <div class="right-sidebar-body customscroll">
        <div class="right-sidebar-body-content">
            ...
            <div class="sidebar-btn-group pb-30 mb-10">
                <a href="javascript:void(0);" class="btn btn-outline-primary sidebar-light active">Sáng</a>
                <a href="javascript:void(0);" class="btn btn-outline-primary sidebar-dark">Tối</a>
            </div>
